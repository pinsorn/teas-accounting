# ภ.ง.ด.50 (`pnd50_050369.pdf`) — radio map p1+p2+p3+p6+p7 (RENDER-CONFIRMED; p1/p2 cont.87b 2026-06-10, p3/p6 cont.89 2026-06-11, p7 C-D recon 2026-06-12)
...
## Page 7 — แบบแจ้งข้อความของกรรมการฯ (confirmed C-D recon 2026-06-12)

⚠️ on-state ปนกันในหน้าเดียว: `Group991` ใช้ `ChoiceN` แต่ `Group992-995` ใช้เลขดิบ `1`/`2`.

| Group | Choice | Option |
|---|---|---|
| `Group991` | `Choice1` | ข้อ 1 (ขาย/ให้กู้/ให้เช่า ต่ำกว่าตลาด): **มี เพราะ** [163] |
| | `Choice2` | ข้อ 1: **ไม่มี** |
| `Group992` | `1` | ข้อ 2 (ซื้อทรัพย์สิน/บริการ เกินปกติ): **มี เพราะ** [164] |
| | `2` | ข้อ 2: **ไม่มี** |
| `Group993` | `1` | ข้อ 3 (เจ้าหนี้/ลูกหนี้ไม่มีตัวตน): **มี เพราะ** [165] |
| | `2` | ข้อ 3: **ไม่มี** |
| `Group994` | `1` | ข้อ 4 (ขาดทุน >3 รอบแต่ขยายกิจการ): **มี เพราะ** [166] |
| | `2` | ข้อ 4: **ไม่มี** |
| `Group995` | `1` | ข้อ 5 (หัก ณ ที่จ่าย/นำส่ง): **ได้ดำเนินการครบถ้วนแล้ว** [167] |
| | `2` | ข้อ 5: **ไม่ได้ดำเนินการ เพราะ** |

C-D filler: **ไม่ tick ทุกกลุ่ม** — เป็นคำรับรองส่วนตัวของกรรมการ (posture เดียวกับ Group92/93).
รายละเอียด field อื่นของ p7: `fieldmap/pnd50_p7_map.md`.
