...
| GET | `/business-units/` | Perm | master.business_unit.read |
...
| GET | `/business-units/{id:int}` | Perm | master.business_unit.read |
...
| GET | `/delivery-orders/{id:long}/paper` | Perm | sales.delivery_order.read |
| GET | `/delivery-orders/{id:long}/pdf` | Perm | sales.delivery_order.read |
...
| GET | `/quotations/` | Perm | sales.quotation.read |
...
| GET | `/sales-orders/` | Perm | sales.sales_order.read |
...
| GET | `/vendors/{id:long}` | Perm | master.vendor.read |
