...
<figure markdown="span">
  ...
  <figcaption>ตัวอย่าง **ภ.พ.30** ที่ระบบกรอกให้ — หัวกระดาษ (ชื่อ/เลขผู้เสียภาษี/สาขา/งวด) + ช่องยอดขายและภาษีขาย − ยอดซื้อและภาษีซื้อ → ภาษีที่ต้องชำระสุทธิ (ยอดตรงกับตัวอย่างบนจอใน 07.01). VAT แสดงแยกจากฐาน</figcaption>
</figure>
