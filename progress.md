...
- **Pushed → PR #32** (incl. the `Microsoft.OpenApi` CVE pin that un-reds main). LEFT: FX PO hardcoded ฿ (both renderers, flagged by Codex); the strategic canonical-DTO unification (handoff doc) remains the durable cure.
