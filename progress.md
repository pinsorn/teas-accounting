...
- **Spec:** `docs/superpowers/specs/2026-07-01-mcp-connectivity-and-oauth-design.md`. **Servers left running for Ham:** backend :5080 (Dev), frontend :3000 (`next start`, prod build). Nothing committed (§10).
