...
- **🔧 รอบแก้ตาม feedback Ham ("ไม่ตรงช่อง" + "ขอเนียบ") — commits `9efc2cd`,`5ef5ce5`:**
  ...
  - **diagnostic `TaxFormFillDiagnostic` (gated TEAS_DIAG=1):** fill **ทุกช่อง**ด้วย synthetic data → `_diag_*.pdf` ตรวจ alignment. verified: ทุก box ตรง (taxId 1-4-5-2-1, 16 calc lines ภ.พ.30 foot, pay-date, income desc, เงื่อนไข 1/2, ใบแนบ 7ราย/2แผ่น). smoke 2× + diag pass.
