...
## 2026-06-15 (cont. 98f — autonomous overnight, ต่อจาก 98e: advisor review fixes บท 6) — **แก้ความถูกต้อง 06.01 เงินเดือน: caption เท็จ "เงินเดือนเท่ากัน" → ตัวเลขจริงรายคน + แก้เพดาน ปกส ฿750→฿875 + guard reproducibility. 2 commits (`71b6ccc`, `a3545b4`). gen-md 29 wt · 140 steps · mkdocs 0 error · 29/29 transpile · ম clean.**
...
- **ค้าง / ถัดไป (handoff Ham):** บท 7 ภาษี (ภ.พ.30/ภ.ง.ด.3/53/1) — **ต้อง orient ก่อน**: หน้า filing พึ่งข้อมูล (เหมือน payroll); เช็คว่าหน้ามีข้อมูลแสดงไหมก่อนเขียน, อ่าน plan.md ยืนยัน next. ถ้าว่าง = ต้อง seed filing ก่อน. · payroll lifecycle (approve/post/pay — ต้อง period สดกัน lock) · บท 8 รายงาน-GL · บท 9 e-Tax.
