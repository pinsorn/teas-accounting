...
- **ค้าง (Ham):** (1) **merge/PR** branch `review/code-review-2026-06-19-fixes` → main. (2) openapi: undocumented routes flagged by docs subagent (quotation reject/convert-to-so, DO create-ti/create-invoice, billing-note create-tax-invoice, etc.) — add to contract if wanted → Sana. (3) DOCS batch was subagent self-report only (not second-reviewed) — low risk, openapi delta already flagged.
