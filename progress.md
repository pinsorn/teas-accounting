...
## 2026-06-11 (cont. 89) — **ภ.ง.ด.50 v2 = default + CIT filing dashboard** ship แล้วถึง FE (plan `2026-06-11-pnd50-v2-dashboard.md`). p3 ladder + p6 งบฐานะ render จริง · preview endpoint single-source · dashboard บน `/tax-filings/cit`. Build **0/0** · Domain **137/137** · Api **294/294 ×2** (teas_test) · tsc **0** · i18n cit parity 65/65 · ম clean.
