...
- **ค้าง / Ham's call:** **deploy** (wipe + reseed prod per Ham — fresh onboard will now get the full CoA) bundling cont.108+109. Repro left prod artifacts (Invoice #2, Receipt #3 draft) — moot after wipe.
