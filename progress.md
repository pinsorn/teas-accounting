...
- **⚠️ footer still "TEAS · v1.8.3"** — version label is API-MinVer-served and these were FE-only deploys; cosmetic, would need an API redeploy from the v1.8.5 tag to bump.
