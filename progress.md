...
## 2026-06-14 (cont. 95 — "RBAC admin UI ทำเลย ให้เสร็จ") — **Per-company RBAC + admin UI (Sprint 13k Plan 1) SHIPPED.** Api **355/0/3** · tsc 0 · next build 0/0 · openapi 114 paths · e2e ✓. Branch `feat/rbac-per-company-admin-ui`.
