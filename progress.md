...
- **Next:** push branch + PR (7 commits incl. the `Microsoft.OpenApi` CVE pin that un-reds main); flagged PO-discount-row + CN/DN cite; the strategic canonical-DTO unification (handoff doc) remains the durable cure.
