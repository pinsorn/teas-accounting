...
namespace Accounting.Infrastructure.Migrations
{
    ...
    [Migration("20260905043849_AddDocumentIdempotencyFence")]
    partial class AddDocumentIdempotencyFence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Bank.StatementLine", b =>
                {
                    ...
                    b.HasIndex("MatchedPaymentVoucherId")
                        .IsUnique()
                        .HasDatabaseName("ix_statement_lines_matched_payment_voucher_id")
                        .HasFilter("matched_payment_voucher_id IS NOT NULL");

                    b.HasIndex("MatchedReceiptId")
                        .IsUnique()
                        .HasDatabaseName("ix_statement_lines_matched_receipt_id")
                        .HasFilter("matched_receipt_id IS NOT NULL");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Expense.ExpenseClaim", b =>
                {
                    ...
                    b.HasIndex("BankAccountId")
                        .HasDatabaseName("ix_expense_claims_bank_account_id");

                    b.HasIndex("BusinessUnitId")
                        .HasDatabaseName("ix_expense_claims_business_unit_id")
                        .HasFilter("business_unit_id IS NOT NULL");

                    b.HasIndex("JournalEntryId")
                        .HasDatabaseName("ix_expense_claims_journal_entry_id");

                    b.HasIndex("CompanyId", "ClaimDate")
                        .HasDatabaseName("ix_expense_claims_company_id_claim_date");

                    b.HasIndex("CompanyId", "DocNo")
                        .IsUnique()
                        .HasDatabaseName("ix_expense_claims_company_id_doc_no")
                        .HasFilter("doc_no IS NOT NULL");

                    b.HasIndex("EmployeeId", "ClaimDate")
                        .HasDatabaseName("ix_expense_claims_employee_id_claim_date");

                    b.ToTable("expense_claims", "expense");
                });

            modelBuilder.Entity("Accounting.Domain.Entities.Expense.ExpenseClaimLine", b =>
                {
                    b.Property<long>("ExpenseClaimLineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("expense_claim_line_id");
                    ...
                    b.HasKey("ExpenseClaimLineId")
                        .HasName("pk_expense_claim_lines");

                    b.HasIndex("ExpenseCategoryId")
                        .HasDatabaseName("ix_expense_claim_lines_expense_category_id");

                    b.HasIndex("ExpenseClaimId", "LineNo")
                        .IsUnique()
                        .HasDatabaseName("ix_expense_claim_lines_expense_claim_id_line_no");

                    b.ToTable("expense_claim_lines", "expense");
                });

            modelBuilder.Entity("Accounting.Domain.Entities.FixedAsset.DepreciationRun", b =>
                {
                    b.Property<long>("DepreciationRunId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("depreciation_run_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("DepreciationRunId"));
                    ...
                    b.HasKey("DepreciationRunId")
                        .HasName("pk_depreciation_runs");

                    b.HasIndex("JournalEntryId")
                        .HasDatabaseName("ix_depreciation_runs_journal_entry_id");

                    b.HasIndex("CompanyId", "PeriodYear", "PeriodMonth")
                        .IsUnique()
                        .HasDatabaseName("ix_depreciation_runs_company_id_period_year_period_month");

                    b.ToTable("depreciation_runs", "fixedasset", t =>
                        {
                            t.HasCheckConstraint("ck_depreciation_runs_month", "period_month BETWEEN 1 AND 12");
                        });
                });

            modelBuilder.Entity("Accounting.Domain.Entities.FixedAsset.DepreciationRunLine", b =>
                {
                    b.Property<long>("DepreciationRunLineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("depreciation_run_line_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("DepreciationRunLineId"));

                    b.Property<decimal>("AccumulatedAfter")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)")
                        .HasColumnName("accumulated_after");
                    ...
                    b.HasKey("DepreciationRunLineId")
                        .HasName("pk_depreciation_run_lines");

                    b.HasIndex("DepreciationRunId")
                        .HasDatabaseName("ix_depreciation_run_lines_depreciation_run_id");

                    b.HasIndex("FixedAssetId", "DepreciationRunId")
                        .IsUnique()
                        .HasDatabaseName("ix_depreciation_run_lines_fixed_asset_id_depreciation_run_id");

                    b.ToTable("depreciation_run_lines", "fixedasset");
                });

            modelBuilder.Entity("Accounting.Domain.Entities.FixedAsset.FixedAsset", b =>
                {
                    b.Property<long>("FixedAssetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("AccumDepAccountId")
                        .HasColumnType("bigint")
                        .HasColumnName("accum_dep_account_id");
                    ...
                    b.Property<DateOnly>("AcquireDate")
                        .HasColumnType("date")
                    ...
                    b.Property<long?>("ActivatedBy")
                        .HasColumnType("bigint")
                        .HasColumnName("activated_by");

                    b.Property<long>("AssetCostAccountId")
                        .HasColumnType("bigint")
                        .HasColumnName("asset_cost_account_id");
                    ...
                    b.Property<long>("DepExpenseAccountId")
                        .HasColumnType("bigint")
                        .HasColumnName("dep_expense_account_id");
                    ...
                    b.Property<string>("DisposalBuyerName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("disposal_buyer_name");
                    ...
                    b.Property<long?>("DisposalJournalEntryId")
                        .HasColumnType("bigint")
                        .HasColumnName("disposal_journal_entry_id");
                    ...
                    b.Property<decimal?>("DisposalVatAmount")
                        .HasPrecision(19, 4)
                        .HasColumnType("numeric(19,4)")
                        .HasColumnName("disposal_vat_amount");

                    b.Property<DateTimeOffset?>("DisposedAt")
                        .HasColumnType("timestamptz(3)")
                        .HasColumnName("disposed_at");

                    b.Property<long?>("DisposedBy")
                        .HasColumnType("bigint")
                    ...
                    b.Property<decimal?>("MonthsDepreciated")
                        .HasPrecision(9, 4)
                        .HasColumnType("numeric(9,4)")
                        .HasColumnName("months_depreciated");
                    ...
                    b.HasIndex("AccumDepAccountId")
                        .HasDatabaseName("ix_fixed_assets_accum_dep_account_id");

                    b.HasIndex("AssetCostAccountId")
                        .HasDatabaseName("ix_fixed_assets_asset_cost_account_id");

                    b.HasIndex("BusinessUnitId")
                        .HasDatabaseName("ix_fixed_assets_business_unit_id")
                        .HasFilter("business_unit_id IS NOT NULL");

                    b.HasIndex("DepExpenseAccountId")
                        .HasDatabaseName("ix_fixed_assets_dep_expense_account_id");

                    b.HasIndex("DisposalJournalEntryId")
                        .HasDatabaseName("ix_fixed_assets_disposal_journal_entry_id");

                    b.HasIndex("VendorInvoiceId")
                        .HasDatabaseName("ix_fixed_assets_vendor_invoice_id");

                    b.HasIndex("CompanyId", "AcquireDate")
                        .HasDatabaseName("ix_fixed_assets_company_id_acquire_date");

                    b.HasIndex("CompanyId", "DocNo")
                        .IsUnique()
                        .HasDatabaseName("ix_fixed_assets_company_id_doc_no")
                        .HasFilter("doc_no IS NOT NULL");

                    b.HasIndex("CompanyId", "Status")
                        .HasDatabaseName("ix_fixed_assets_company_id_status");

                    b.ToTable("fixed_assets", "fixedasset", t =>
                        {
                            t.HasCheckConstraint("ck_fixed_assets_salvage", "salvage_value >= 0 AND salvage_value <= cost");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Ledger.FiscalYearClose", b =>
                {
                    b.Property<int>("FiscalYearCloseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("fiscal_year_close_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("FiscalYearCloseId"));
                    ...
                    b.Property<long?>("ClosingJournalId")
                        .HasColumnType("bigint")
                        .HasColumnName("closing_journal_id");

                    b.Property<int>("CompanyId")
                        .HasColumnType("integer")
                        .HasColumnName("company_id");

                    b.Property<DateOnly>("FiscalEndDate")
                        .HasColumnType("date")
                        .HasColumnName("fiscal_end_date");

                    b.Property<DateOnly>("FiscalStartDate")
                        .HasColumnType("date")
                    ...
                    b.Property<long?>("ReversingJournalId")
                        .HasColumnType("bigint")
                        .HasColumnName("reversing_journal_id");

                    b.HasKey("FiscalYearCloseId")
                        .HasName("pk_fiscal_year_closes");

                    b.HasIndex("CompanyId", "FiscalYear")
                        .IsUnique()
                        .HasDatabaseName("ix_fiscal_year_closes_company_id_fiscal_year")
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Ledger.JournalEntry", b =>
                {
                    ...
                    b.Property<bool>("IsClosingEntry")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_closing_entry");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Master.CompanyProfile", b =>
                {
                    ...
                    b.Property<string>("DefaultDocNotesJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("default_doc_notes");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Master.Product", b =>
                {
                    ...
                    b.HasIndex("BusinessUnitId")
                        .HasDatabaseName("ix_products_business_unit_id");
                    ...
                    b.ToTable("products", "master", t =>
                        {
                            t.HasCheckConstraint("ck_products_purpose", "is_saleable OR is_purchasable");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Payroll.Payslip", b =>
                {
                    ...
                    b.Property<string>("OtherDeductionsReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("other_deductions_reason");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Purchase.PaymentVoucher", b =>
                {
                    ...
                    b.HasIndex("BusinessUnitId")
                        .HasDatabaseName("ix_payment_vouchers_business_unit_id")
                        .HasFilter("business_unit_id IS NOT NULL");
                    ...
                    b.HasIndex("CompanyId", "DocNo")
                        .IsUnique()
                        .HasDatabaseName("ix_payment_vouchers_company_id_doc_no")
                        .HasFilter("doc_no IS NOT NULL");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Purchase.VendorInvoice", b =>
                {
                    ...
                    b.HasIndex("BusinessUnitId")
                        .HasDatabaseName("ix_vendor_invoices_business_unit_id")
                        .HasFilter("business_unit_id IS NOT NULL");
                    ...
                    b.HasIndex("CompanyId", "DocNo")
                        .IsUnique()
                        .HasDatabaseName("ix_vendor_invoices_company_id_doc_no")
                        .HasFilter("doc_no IS NOT NULL");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Sales.BillingNote", b =>
                {
                    ...
                    b.HasIndex("SalesOrderId")
                        .HasDatabaseName("ix_billing_notes_sales_order_id")
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Sales.Quotation", b =>
                {
                    ...
                    b.Property<long?>("CreatedViaApiKeyId")
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("CompanyId", "CreatedViaApiKeyId", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("ux_quotations_idem")
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Sales.Receipt", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "DocNo")
                        .IsUnique()
                        .HasDatabaseName("ix_receipts_company_id_doc_no")
                        .HasFilter("doc_no IS NOT NULL");
                    ...
                    b.HasIndex("CompanyId", "CreatedViaApiKeyId", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("ux_receipts_idem")
                        .HasFilter("idempotency_key IS NOT NULL");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Sales.TaxAdjustmentNote", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "DocNo")
                        .IsUnique()
                        .HasDatabaseName("ix_tax_adjustment_notes_company_id_doc_no")
                        .HasFilter("doc_no IS NOT NULL");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Sales.TaxInvoice", b =>
                {
                    ...
                    b.HasIndex("DeliveryOrderId")
                        .HasDatabaseName("ix_tax_invoices_delivery_order_id")
                        .HasFilter("delivery_order_id IS NOT NULL");
                    ...
                    b.HasIndex("CompanyId", "DocNo")
                        .IsUnique()
                        .HasDatabaseName("ix_tax_invoices_company_id_doc_no")
                        .HasFilter("doc_no IS NOT NULL");
                    ...
                    b.HasIndex("CompanyId", "CreatedViaApiKeyId", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("ux_tax_invoices_idem")
                        .HasFilter("idempotency_key IS NOT NULL");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Tax.WhtCertificate", b =>
                {
                    ...
                    b.Property<string>("Pnd2IncomeCode")
                        .HasMaxLength(1)
                        .HasColumnType("character varying(1)")
                        .HasColumnName("pnd2_income_code");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Expense.ExpenseClaim", b =>
                {
                    b.HasOne("Accounting.Domain.Entities.Bank.BankAccount", null)
                        .WithMany()
                        .HasForeignKey("BankAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_expense_claims_bank_accounts_bank_account_id");

                    b.HasOne("Accounting.Domain.Entities.Master.BusinessUnit", null)
                        .WithMany()
                        .HasForeignKey("BusinessUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_expense_claims_business_units_business_unit_id");

                    b.HasOne("Accounting.Domain.Entities.Master.Employee", null)
                        .WithMany()
                    ...
                    b.HasOne("Accounting.Domain.Entities.Ledger.JournalEntry", null)
                        .WithMany()
                        .HasForeignKey("JournalEntryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_expense_claims_journal_entries_journal_entry_id");
                });

            modelBuilder.Entity("Accounting.Domain.Entities.Expense.ExpenseClaimLine", b =>
                {
                    b.HasOne("Accounting.Domain.Entities.Sys.ExpenseCategory", null)
                        .WithMany()
                        .HasForeignKey("ExpenseCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_expense_claim_lines_expense_categories_expense_category_id");

                    b.HasOne("Accounting.Domain.Entities.Expense.ExpenseClaim", null)
                        .WithMany("Lines")
                        .HasForeignKey("ExpenseClaimId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_expense_claim_lines_expense_claims_expense_claim_id");
                });
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.FixedAsset.DepreciationRun", b =>
                {
                    b.HasOne("Accounting.Domain.Entities.Ledger.JournalEntry", null)
                        ...
                        .HasForeignKey("JournalEntryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_depreciation_runs_journal_entries_journal_entry_id");
                });

            modelBuilder.Entity("Accounting.Domain.Entities.FixedAsset.DepreciationRunLine", b =>
                {
                    b.HasOne("Accounting.Domain.Entities.FixedAsset.DepreciationRun", null)
                        .WithMany("Lines")
                        .HasForeignKey("DepreciationRunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_depreciation_run_lines_depreciation_runs_depreciation_run_id");

                    b.HasOne("Accounting.Domain.Entities.FixedAsset.FixedAsset", null)
                        .WithMany()
                        .HasForeignKey("FixedAssetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_depreciation_run_lines_fixed_assets_fixed_asset_id");
                });
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.FixedAsset.FixedAsset", b =>
                {
                    b.HasOne("Accounting.Domain.Entities.Master.ChartOfAccount", null)
                        .WithMany()
                        .HasForeignKey("AccumDepAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_fixed_assets_chart_of_accounts_accum_dep_account_id");
                    ...
                    b.HasOne("Accounting.Domain.Entities.Master.ChartOfAccount", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_fixed_assets_chart_of_accounts_asset_cost_account_id");

                    b.HasOne("Accounting.Domain.Entities.Master.BusinessUnit", null)
                        .WithMany()
                        .HasForeignKey("BusinessUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_fixed_assets_business_units_business_unit_id");

                    b.HasOne("Accounting.Domain.Entities.Master.ChartOfAccount", null)
                        .WithMany()
                        .HasForeignKey("DepExpenseAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_fixed_assets_chart_of_accounts_dep_expense_account_id");

                    b.HasOne("Accounting.Domain.Entities.Ledger.JournalEntry", null)
                        .WithMany()
                        .HasForeignKey("DisposalJournalEntryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_fixed_assets_journal_entries_disposal_journal_entry_id");

                    b.HasOne("Accounting.Domain.Entities.Purchase.VendorInvoice", null)
                        .WithMany()
                        .HasForeignKey("VendorInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_fixed_assets_vendor_invoices_vendor_invoice_id");
                });
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Master.Product", b =>
                {
                    b.HasOne("Accounting.Domain.Entities.Master.BusinessUnit", null)
                        ...
                        .HasForeignKey("BusinessUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_products_business_units_business_unit_id");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Purchase.PaymentVoucher", b =>
                {
                    b.HasOne("Accounting.Domain.Entities.Master.BusinessUnit", null)
                        ...
                        .HasForeignKey("BusinessUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_payment_vouchers_business_units_business_unit_id");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Purchase.VendorInvoice", b =>
                {
                    b.HasOne("Accounting.Domain.Entities.Master.BusinessUnit", null)
                        ...
                        .HasForeignKey("BusinessUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_vendor_invoices_business_units_business_unit_id");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Sales.BillingNote", b =>
                {
                    ...
                    b.HasOne("Accounting.Domain.Entities.Sales.SalesOrder", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_billing_notes_sales_orders_sales_order_id");
                });
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Sales.TaxInvoice", b =>
                {
                    ...
                    b.HasOne("Accounting.Domain.Entities.Sales.DeliveryOrder", null)
                        ...
                        .HasForeignKey("DeliveryOrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_tax_invoices_delivery_orders_delivery_order_id");
                    ...
                    b.HasOne("Accounting.Domain.Entities.Sales.SalesOrder", null)
                        ...
                        .HasForeignKey("SalesOrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_tax_invoices_sales_orders_sales_order_id");
                });
