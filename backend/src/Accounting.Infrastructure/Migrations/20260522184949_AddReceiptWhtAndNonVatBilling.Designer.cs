...
namespace Accounting.Infrastructure.Migrations
{
    ...
    partial class AddReceiptWhtAndNonVatBilling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Sales.ReceiptApplication", b =>
                {
                    ...
                    b.ToTable("receipt_applications", "sales", t =>
                        {
                            t.HasCheckConstraint("ck_receipt_applications_one_doc", "(tax_invoice_id IS NOT NULL) <> (delivery_order_id IS NOT NULL)");
                        });
                });
