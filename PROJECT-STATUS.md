...
Commit ล่าสุด: `276c7d2`. **Remote: `github.com/pinsorn/teas-accounting` (PRIVATE)** — push หลังทุก commit (ตั้ง 2026-06-10). ห้ามเปลี่ยนเป็น public โดยไม่ล้าง history (dev creds + MFA dev key อยู่ใน history).
...
- ☑ **git remote** — `github.com/pinsorn/teas-accounting` PRIVATE (2026-06-10); push ทุก commit. ☐ backup DB (`accounting_dev` dump) ยังไม่มี
...
1. ~~git remote~~ ☑ 2026-06-10 (`pinsorn/teas-accounting` private) — เหลือ ☐ DB dump backup
