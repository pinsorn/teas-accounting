...
> **หมายเหตุเมนู:** เมนู "ใบกำกับภาษี" (พร้อมกับใบลดหนี้/ใบเพิ่มหนี้) แสดงเฉพาะกิจการที่
> จดทะเบียน VAT — กิจการไม่จด VAT จะไม่เห็นเมนูนี้เลย (ดูรายละเอียดที่ 04.10).
  `.trim(),
  prerequisites: [
  ...
  await capture('step-06-posted', {
    ...
    caption:
      ...
      ' MM-YYYY-PREFIX-BU-NNNN เช่น 07-2026-TI-ECOM-0001, ไม่ขาดช่วง) และเปลี่ยนสถานะเป็น "โพสต์แล้ว".' +
