...
(ซื้อ "สินค้า/ของ" ไม่ต้องหัก ณ ที่จ่าย — จึงใช้ผู้ขายค่าเช่า ไม่ใช่ผู้ขายของจาก 05.01.)
  ...
  await capture('step-03-draft', {
    ...
    caption:
      ...
      ' ยอดจ่ายสุทธิ. ระบบมีข้อความกำกับ "ผู้อนุมัติต้องไม่ใช่ผู้สร้าง (SoD)" ข้างวันที่' +
      ' (สำหรับ super-admin คนเดียวยังอนุมัติเองได้ต่อ — ดู 05.01). ต้อง "อนุมัติ" แล้ว' +
      ' "บันทึก (Post)" จึงลงบัญชีและออก 50ทวิ. วันที่เอกสารล็อกเป็นวันนี้ แก้ไม่ได้',
  });
