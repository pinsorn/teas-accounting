...
ยินดีรับ contribution! โปรเจกต์นี้อยู่ภายใต้ [GNU AGPL-3.0](LICENSE) — ทุก contribution ถือว่าอยู่ภายใต้
license เดียวกัน คุณนำไปใช้ / แก้ / เปิดเป็นบริการได้ แต่ถ้าแก้ไขแล้วนำไปให้บริการ (รวมถึงผ่านเครือข่าย / SaaS)
ต้องเปิดเผย source ที่แก้ไขด้วย
